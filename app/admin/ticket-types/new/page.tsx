...
export default function CreateTicketTypePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Crear el tipo de ticket con los beneficios filtrados
      ...
      setError(err.message || "Error al crear el tipo de ticket")
    } finally {
        ...
        <section className="py-16 px-4 md:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center justify-between mb-8">
              <h1 className="text-3xl md:text-4xl font-bold">Crear Nuevo Tipo de Ticket</h1>
              <Link
            ...
            {isLoadingEvents ? (
              ...
              <form onSubmit={handleSubmit} className="bg-dark-gray p-6 rounded-lg">
                ...
                <div className="mt-8 flex flex-wrap gap-4">
                  ...
                  >
                    {isSubmitting ? "Creando..." : "Crear Tipo de Ticket"}
                  </button>
